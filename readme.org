...
** Mail
#+begin_src elisp :tangle ~/.config/emacs/lisp/packages.el
...
#+end_src
** Reka
#+begin_src elisp :tangle ~/.config/emacs/lisp/init.el
(add-to-list 'load-path "/home/spy/Documents/reka/lisp")
(require 'reka)
(reka-enable)
#+end_src
