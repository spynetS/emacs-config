...
(register-definition-prefixes "keybindings" '("rc/duplicate-line"))
...
(register-definition-prefixes "ui" '("jetbrains" "my/split-window-" "thanos/wtype-text"))

;;;***

;;;### (autoloads nil nil ("packages.el" "secret.el" "treesitter.el")
;;;;;;  (0 0 0 0))
